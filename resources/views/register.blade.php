...
<html lang="en">
  <head>
    ...
    <title>Web-Based Management System of Barangay Paloyon Oriental</title>
    ...
    <div class="wrapper vh-100">
        ...
        <form  method="POST" enctype="multipart/form-data"  action="/register" class="col-lg-6 col-md-8 col-10 mx-auto"  >
          ...
          @foreach($setting as $settings)
            <a class="navbar-brand mx-auto mt-2 flex-fill text-center" href="./index.html">
              <img src="{{$settings->barangay_logo ? asset ('storage/' .$settings->barangay_logo) : asset('/storage/no/-image.png')}}" style="width: 30%">
            </a>
            @endforeach
     ...
     <div class="form-row">
      ...
      <div class="form-group col-sm-4">
        ...
        <input type="text"  name="civil_status" class="form-control" value="{{old('civil_status')}}"> 
        @Error('civil_status')
            <p class="text-red-500 text-xs mt-1">{{$message}}</p>
           @enderror
      </div>
    ...
    <div class="form-row">
      ...
      <div class="form-group col-sm-6">
        ...
        @Error('password')
          ...
          <div class="row mb-4">
            <div class="col-md-6">
              <div class="form-group">
                ...
                <input type="file" name="profile_image" id="inputPassword5">
                @Error('profile_image')
                <p class="text-red-500 text-xs mt-1">{{$message}}</p>
               @enderror
              </div>
              <div class="form-group">
                ...
                <input type="file" name="image_id_birth" id="inputPassword6">
          ...
          <p class="mt-2 mb-3 text-center">Already have an account? <a href="/residentLoginPage">Sign Up</p></a>
