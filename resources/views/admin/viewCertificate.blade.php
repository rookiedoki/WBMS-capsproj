    ...
    <div class="row align-items-center h-100">
      <form  method="POST" enctype="multipart/form-data"  action="/registration" class="col-lg-8 col-md-8 col-10 mx-auto"  >
        ...
        <div class="mx-auto text-center my-4">
          ...
          <img class="img-view"src="{{$reg->profile_image ? asset ('storage/' .$reg->profile_image) : asset('/storage/images/-image.png')}}" alt=""  />		
        </div>
        ...
        <div class="row mb-4">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <a href="#showImage" class="show" data-toggle="modal"><img class="img-view"src="{{$reg->profile_image ? asset ('storage/' .$reg->profile_image) : asset('/storage/images/-image.png')}}" alt=""  /></a>
            ...
            <div class="form-group">
              ...
              <input type="file"  name="image_id-birth" >
              @Error('image_id-birth')
              <p class="text-red-500 text-xs mt-1">{{$message}}</p>
             @enderror
            </div>
          </div>
          <div class="col-md-6">
            ...
            <p class="small text-muted mb-2"> To create a new account, you have upload an image of your ID or Birth Certicate to verify if you're truly a residence of the barangay </p>
            <p class="small text-muted mb-2"> NOTE: </p>
            <ul class="small text-muted pl-4 mb-0">
              <li>The image must clear and it can be read clearly </li>
              <li>Either ID or Birth Certiciate can be accepted</li>
