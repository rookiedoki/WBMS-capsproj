        ...
        <div class="col-sm-4">
            <div class="card user-card">
                ...
                <div class="card-block">
                    ...
                    <h5 class="f-w-600 m-t-25 m-b-10">{{$officials->name}}</h5>
                    <p class="text-muted">{{$officials->gender}} | {{$officials->age}} | {{$officials->birthdate}}</p>
                    <hr>
                    <p class="text-muted m-t-15">{{$officials->email}} </p>
                    <p class="text-muted m-t-15">{{$officials->phone_number}} </p>
