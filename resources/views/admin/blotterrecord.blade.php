...
<div class="row">
  ...
  <div class="col-md-12 my-4">
    <h2 class="h4 mb-1">Blotter Records</h2>
    ...
    <div class="card shadow">
      <div class="card-body"> 
        ...
        {{--  --}}
          ...
          <form action="{{url('/blotterrecord/store3')}}" method="post" enctype="multipart/form-data">
          ...
          <table class="table">
            ...
            <tbody>
              @foreach($files3 as $file)
                <tr>
                  ...
                  <td width="25%">
                    ...
                    <a href="#deleteFile3{{$file->id}}" data-toggle="modal"><button class="btns btn2"><i class="fa fa-trash"></i></button></a>
              ...
              <div id="deleteFile3{{$file->id}}" class="modal fade">
                    ...
                    <div class="modal-content">
                        <form>
                            ...
                            <div class="footer" style="text-align: right;">
                                ...
                                <a class="btn btn-danger" href="{{url('deleteFile3',$file->id)}}">Delete</a>
                            </div>
