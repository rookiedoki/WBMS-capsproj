...
<div class="card shadow">
    <div class="card-body">
      <div class="toolbar">
        <form class="form">
          <div class="form-row">
            <div action="/blotter" class="form-group col-auto">
    ...
    <table class="table table-borderless table-hover">
      ...
      @foreach($blo as $blotter)
        ...
        <td class="show" >{{$blotter->date}}</td>
            <td class="show" >{{$blotter->status}}</td>
            <td width="15%">
                <a href="#editBlotterModal{{$blotter->id}}" data-toggle="modal"><button class="btns btn1"><i class="fa fa-eye"></i></button></a>
...
<div id="editBlotterModal{{$blotter->id}}" class="modal fade">
  ...
  <form action="{{url('/submitBlotter/blotterLetter',$blotter->id)}}">

  <div class="modal-header">						
      <h4 class="modal-title">Save Blotter Report</h4>
      <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
  </div>
  ...
  <div class="row register-form">
    <div class="col-sm-12">
        <div class="form-group">
            <div class="modal-body">
            <label>Date</label>
            <input type="text" class="form-control" name="date" value="{{$blotter->date}}" disabled>
        </div>	
  ...
  <div class="col-sm-6">
      <div class="modal-body">					
          <div class="form-group">
              ...
              <input type="text" class="form-control" name="complainant" value="{{$blotter->complainant}}" disabled>
  ...
  <div class="col-sm-6">
      <div class="form-group">
          ...
          <input type="text" class="form-control" name="respondent" value="{{$blotter->respondent}}" disabled>
      </div>
...
<div class="row register-form">
  <div class="col-sm-6">
      <div class="modal-body">
          <div class="form-group">
          <label>Victim</label>
          <input type="date" class="form-control" name="victim" value="{{$blotter->victim}}" disabled>
       </div>
  ...
  <div class="col-sm-6">
    <div class="modal-body">
        ...
        <input type="date" class="form-control" name="location" value="{{$blotter->location}}" disabled>
     </div>
