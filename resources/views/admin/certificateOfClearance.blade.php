          ...
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <div class="modal-body">
                <form  action="{{url('certificateOfClearance/barangayClearance',$clearance->id)}}" >
                    ...
                    <div class="form-group">
                      ...
                      <div id="image-show-area">
                        <img src="{{$clearance->screenshot ? asset ('storage/' .$clearance->screenshot) : asset('/storage/images/-image.png')}}" alt="screenshot" style="width: 100%"  />
                      </div>
                    </div>
